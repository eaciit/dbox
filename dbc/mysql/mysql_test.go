...
// 	}
// 	defer c.Close()
	// e = c.NewQuery().From("tes").Where(dbox.Or(dbox.Eq("id", "22"),dbox.Eq("name", "dsad2"))).Delete().Exec(nil)
	// if e != nil {
	...
	// 	return
	// }
	// e = c.NewQuery().From("testtables").Where(dbox.And(dbox.Eq("id", "3"),dbox.Eq("title", "user3,gjg,jkk"),dbox.Eq("title", "user3"))).Delete().Exec(nil)
	// if e != nil {
	// 	t.Errorf("Unablet to delete table %s\n", e.Error())
	// 	return
	// }
